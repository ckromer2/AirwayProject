...
public class PlanesAirportsDistances
{
    ...
    public List<List<float>> Distances { get; private set; }
    ...
    public PlanesAirportsDistances() 
    {
        ...
        Distances = new List<List<float>> {   new List<float> { 0, 447.69f, 928.5f, 287.35f, 2049, 2016, 424, 315, 621, 1021, 1198, 1821, 96 },
